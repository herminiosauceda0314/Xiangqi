...
public class PanelMenuPrincipal extends JPanel {
    ...
    public PanelMenuPrincipal(AppFrame app, StorageImpl storage) {
        this.app = app;
    ...
    private void initUI() {
        ...
        gbc.gridy = 0; gbc.ipadx = 0;
        add(lblXiangqi, gbc);
 
        JLabel lblBienvenida = new JLabel(
            "BIENVENIDO: " + app.getPlayerLogueado().getUsername(),
        ...
        gbc.ipadx = 120;
        gbc.gridy = 2; add(btnJugar,    gbc);
        gbc.gridy = 3; add(btnCuenta,   gbc);
        gbc.gridy = 4; add(btnReportes, gbc);
        gbc.gridy = 5; add(btnLogout,   gbc);
    ...
    private void abrirJuego() {
        ...
        JButton btnVolver = crearBoton("Volver");
        gbc.gridy = todos.size() + 1; gbc.ipadx = 100;
        panel.add(btnVolver, gbc);
        btnVolver.addActionListener(e -> app.mostrar("PRINCIPAL"));
